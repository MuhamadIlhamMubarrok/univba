        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="ht-auto rounded-circle" width="30" height="30"
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    ...
                    <ul class="list-unstyled p-1">
                        <li class="dropdown-item py-2 {{ request()->routeIs('profile') ? 'bg-primary' : '' }}"
                            onclick="window.location.href='{{ route('profile') }}'" style="cursor: pointer;">
                            <a href="{{ route('profile') }}" class="text-body ms-0 text-white">
                                <i class="me-2 icon-md" data-feather="user"></i>
                                <span>Profile</span>
                            </a>
                        </li>

                        <li class="dropdown-item py-2 {{ request()->routeIs('changePassword') ? 'bg-primary' : '' }}"
                            onclick="window.location.href='{{ route('changePassword') }}'" style="cursor: pointer;">
                            <a href="{{ route('changePassword') }}" class="text-body ms-0 text-white">
                                <i class="me-2 icon-md" data-feather="user"></i>
                        ...
                        <li class="dropdown-item py-2"
                            ...
                            <form method="POST" action="{{ route('logout') }}" style="display: inline;">
                                @csrf
                                <a href="#" class="text-body ms-0" onclick="event.preventDefault();">
