                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="panel-heading">
                            <a href="{{ route('menu.create') }}" class="btn btn-primary mb-3"><i
                                    class="fa fa-plus fa-fw"></i> Add Menu</a>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('menu.toggle-active', $menu->menu_id) }}"
                                                    class="btn btn-{{ $menu->active ? 'success' : 'primary' }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('menu.toggle-active', $submenu->menu_id) }}"
                                                        class="btn btn-{{ $submenu->active ? 'success' : 'primary' }}">
