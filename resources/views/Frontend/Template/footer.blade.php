<div data-aos="fade-up"
    ...
    <div data-aos="fade-up" class="md:w-[60%] flex flex-col gap-y-5">
        <img src="{{ asset('./images/logo/logo1.png') }}" alt="logo aing" data-aos="fade-up" class="w-[150px]">
        <div data-aos="fade-up" class="flex flex-col md:flex-row text-white gap-y-5 md:gap-x-[200px]">
            <div data-aos="fade-up" class="text-start">
                <h1 data-aos="fade-up" class="font-bold font-Anek text-base md:text-lg lg:text-xl">Universitas Kepanjen
                </h1>
                <p data-aos="fade-up" class="w-full md:w-[400px] text-sm md:text-base lg:text-lg">Jl. Trunojoyo No.16,
                    Krajan, Panggungrejo, Kec. Kepanjen, Kabupaten Malang, Jawa Timur 65163
                </p>
            </div>
        </div>
        ...
        <div class="flex flex-col text-white gap-y-4">
            ...
            <div class="flex flex-row justify-center md:justify-start items-center gap-x-4 mb-6">
                {{-- IG --}}
                <a href=" https://www.instagram.com/k2.univ_alirsyad/" target="_blank">
                ...
                {{-- FACEBOOK --}}
                <a href=" https://www.facebook.com/profile.php?id=61571572000797" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" class="hover:animate-pulse" width="35" height="35"
                        viewBox="-2 -2 24 24">
                        <g fill="#F9F51A">
                            <path
    ...
    <div data-aos="fade-up" class="flex flex-col md:items-end md:justify-end items-start justify-center pb-2">
        ...
        <p class="text-white text-xs md:text-sm lg:text-base text-center">Copyright © 2024 - TEAM IT kuliahkaryawan
        </p>
        <x-footer></x-footer>
    </div>
</div>
