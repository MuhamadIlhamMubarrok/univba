    ...
    <div data-aos="fade-up" class="md:w-[60%] flex flex-col gap-y-5">
        ...
        <div class="flex flex-col text-white gap-y-1">
            ...
            <div class="flex flex-row justify-start items-center gap-x-4 ">
                {{-- IG --}}
                <a href="https://www.instagram.com/k2.univbanten/?hl=en" target="_blank">
                ...
                {{-- FACEBOOK --}}
                <a href="https://www.facebook.com/people/Univ-Banten/pfbid0KQpuKFBqy6YHpiXxm7Wuhg6aDjUFqwPnqpQCeyRpU6TCvLShtLKkucG5BJgQPRNFl/"
                    target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" class="hover:animate-pulse" width="35" height="35"
                        viewBox="-2 -2 24 24">
                        <g fill="#FAD22E">
