...
<header class="page-header" style="margin: 10px 20px 10px;">
    <nav>
        ...
        <a href="/">
            <img class="logo horizontal-logo" style="width: 200px; margin-top: 5px;" src="/images/logo/header-azzuhra.png" alt="Institut Az Zuhra Kuliah Karyawan">
            <img class="logo vertical-logo" style="width: 250px;" src="/images/logo/header-azzuhra.png" alt="Institut Az Zuhra Kuliah Karyawan">
        </a>
        <div class="top-menu-wrapper">
            <ul class="top-menu">
                @foreach($mainMenus as $menu)
                    <li class="has-dropdown" style="font-weight: bold; position: relative;">
                        <a style="color: #000;" href="{{ $menu->url }}">{{ $menu->menu }}</a>
                        @php
                            // Filter submenus for the current menu item
