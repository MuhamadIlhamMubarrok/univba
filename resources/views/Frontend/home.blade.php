    ...
    @section('content')
        ...
        <section class="no-mb">
            <div class="centered">
                <div class="animated-title text-center" style="--text: 'Institut Az Zuhra'; margin-top: 10px;">Institut Az
                    Zuhra
                </div>
                <div>
                    <img style="width: 100%; margin-top: 20px;" src="/images/banner-slider/Baner-Azzuhra.png"
                ...
                <div class="pricing-table-wrapper">
                    <ul class="pricing-table">
                        @foreach ($berita as $item)
                            <li class="pricing-table__item pricing-table__item--popular" style="background-color: #e5e5e5;"
                                data-popular="{{ $item->tanggal_berita }}">
                                <img src="{{ $item->path }}{{ $item->file_foto }}" alt="{{ $item->judul }}"
                                    style="border-radius: 15px; width: 60%;" />
                                <hr>
                                <h3 class="post-title"> <a
                                        href="{{ url('berita-terkini/' . $item->slug) }}">{{ $item->judul }}</a></h3>
                                <p class="post-description">{{ $item->ringkasan }}</p><br>
                                <a href="{{ url('berita-terkini/' . $item->slug) }}" class="pricing-table__button"
                                    style="background: #458edc; border: 1px solid #fff;">Selengkapnya</a>
                            </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="pricing-table-wrapper">
                    <ul class="pricing-table">
                        <li class="pricing-table__item pricing-table__item--popular" data-popular="Kuota Terbatas">
                            <img src="/images/logo/logo-azzuhra.png" alt="Institut Az zuhra kelas karyawan"
                                class="pricing-table__img" />
                            ...
                            <div class="col-sm-4">
                                <div class="box-image">
                                    ...
                                    <div class="text">
                                        ...
                                        <p class="buttons">
                                            <a href="/images/media/{{ $image->file }}"
