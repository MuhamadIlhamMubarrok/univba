...
@section('content')
    <x-header-section-page title="Struktur Organisasi Mulia Darma Pratama" breadcrumb-home="Home" breadcrumb-current="Struktur Organisasi" />
    ...
    <div data-aos="fade-up" class=" py-16 mt-8 ">
        <div data-aos="fade-up" class="container mx-auto px-4 lg:px-20">
            ...
            <div data-aos="fade-up" class="flex justify-center">
                <img src="{{ asset('./images/image/') }}" alt="Struktur Organisasi Mulia Darma Pratama" data-aos="fade-up"
            ...
            <div data-aos="fade-up"
                ...
                <p data-aos="fade-up" class="text-gray-700 font-dmsans leading-relaxed text-center ">
                    Struktur organisasi Mulia Darma Pratama dirancang untuk menciptakan sinergi antar unit,
